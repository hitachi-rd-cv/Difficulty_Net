...
def mixup_criterion(criterion, pred, y_a, y_b, lam, batch_weights=None, indx=None):
    if indx is not None and batch_weights is not None:
        return (batch_weights * lam * criterion(pred, y_a)) + (batch_weights[indx] * (1 - lam) * criterion(pred, y_b))
