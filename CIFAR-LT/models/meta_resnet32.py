...
def normedlinear(x, weight, bias=None):
   out = F.normalize(x, dim=1).mm(F.normalize(weight.T, dim=0))
   out *= 30
   return out
...
class MetaLinear(MetaModule):
    def __init__(self, *args, **kwargs):
        ...
        #self.fc = NormedLinear(*args, **kwargs)
        self.register_buffer('weight', to_var(ignore.weight.data, requires_grad=True))
        self.register_buffer('bias', to_var(ignore.bias.data, requires_grad=True))
        #self.bias = torch.zeros(100, requires_grad=False)
    ...
    def forward(self, x):
        ...
        #return self.fc(x)
        #return normedlinear(x, self.weight, )

    def named_leaves(self):
        return [('weight', self.weight),('bias', self.bias)]  #('bias', self.bias)
        #return [('weight', self.fc.weight), ('bias', self.fc.bias)]
...
class ResNet32(MetaModule):
    def __init__(self, num_classes, block=BasicBlock, num_blocks=[5, 5, 5]):
        ...
        self.linear = MetaLinear(64, num_classes,) #bias=True
...
class ResNet32_ft(MetaModule):
    def __init__(self, num_classes, block=BasicBlock, num_blocks=[5, 5, 5]):
        super(ResNet32_ft, self).__init__()
        self.in_planes = 16
...
class VNet(MetaModule):
    def __init__(self, input, hidden1, hidden2, output):
        ...
        self.linear1 = nn.Linear(input, hidden1, bias=False)
        self.relu1 = nn.ReLU(inplace=True)
        self.linear2 = nn.Linear(hidden1, hidden2, bias=False)
        self.relu2 = nn.ReLU(inplace=True)
        #self.linear3 = MetaLinear(hidden1, output, bias=False)
        self.linear3 = nn.Linear(hidden2, output, bias=False)
